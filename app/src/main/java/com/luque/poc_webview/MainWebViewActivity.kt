...
import com.luque.poc_webview.databinding.ActivityMainWebViewBinding
...
class MainWebViewActivity : AppCompatActivity() {
    ...
    private fun handleLoginSuccess(token: String) {
        runOnUiThread {
            Toast.makeText(this, "Login via WebView bem-sucedido!", Toast.LENGTH_SHORT).show()
            val intent = Intent(this, HomeActivity::class.java).apply {
                putExtra("USER_TOKEN", token)
                putExtra("ORIGIN", "WEBVIEW") // Sinalizador de Origem
            }
